# Generated by Django 5.0.2 on 2024-03-24 07:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('menproducts', '0003_rename_products_product_profile'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='menproducts.product')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
